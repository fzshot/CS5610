defmodule CalcTest do
  ...
  test "special test" do
    assert_in_delta Calc.main("7 - 5 / ((8 + 11) * 9) + 7"), 13.97, 0.01
    assert_in_delta Calc.main("7 - (5 / ((8 + 11) * 9) + 7)"), -0.0292, 0.0001
    assert_in_delta Calc.main("(7 - 5 / ((8 + 11) * 9)) + 7"), 13.97, 0.01
    assert_in_delta Calc.main("7 - 14 * (14 - 10 / (15 + 8))"), -182.91, 0.01
  end
